<div class="card mb-3"><img class="card-img-top" src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/generic/13.jpg"
        alt="" />
    <div class="card-body">
            ...
            <div class="col">
                <div class="d-flex">
                    ...
                    <div class="flex-1 fs--1">
                        <h5 class="fs-0"><?php echo $event_detail['e_title'] ?></h5>
                        <p class="mb-0">by <a href="#!"><?= $event_detail['username'] ?></a></p><span
                            class="fs-0 text-warning fw-semi-bold">$49.99 – $89.99</span>
                    </div>
                </div>
            </div>
            <div class="col-md-auto mt-4 mt-md-0"><button class="btn btn-falcon-default btn-sm me-2" type="button"><span
                        class="fas fa-heart text-danger me-1"></span>235</button><button
                    class="btn btn-falcon-default btn-sm me-2" type="button"><span
                        class="fas fa-share-alt me-1"></span>Share</button><button
                    class="btn btn-falcon-primary btn-sm px-4 px-sm-5" type="button">Register</button></div>
        </div>
    </div>
</div>
<div class="row g-0">
    <div class="col-lg-8 pe-lg-2">
        <div class="card mb-3 mb-lg-0">
            <div class="card-body">
                <h5 class="fs-0 mb-3"><?= $event_detail['e_title'] ?></h5>
                <p><?= $event_detail['e_description'] ?></p>
                <p>Join us as we ring in the New Year with a dazzling display over Boston Harbor. Public viewing is free
                    and available from the Harborwalk of these suggested viewing locations:</p>
                <ul>
                ...
                <p>Register here for a reminder and updates about the harbor fireworks and other waterfront public
                    programs as they become available. Be the first to be notified for popular waterfront New Year's Eve
                    public activities.</p>
                ...
                <div class="icon-group"><a class="icon-item text-facebook" href="#!"><span
                            ...
                            class="fab fa-google-plus-g"></span></a><a class="icon-item text-linkedin" href="#!"><span
                            class="fab fa-linkedin-in"></span></a><a class="icon-item text-700" href="#!"><span
    ...
    <div class="col-lg-4 ps-lg-2">
        <div class="sticky-sidebar">
            <div class="card mb-3 fs--1">
                <div class="card-body">
                    <h6>Date And Time</h6>
                    <p class="mb-1"><?= $event_detail['e_start_date'] ?> 11:59 PM –
                        <br /><?= $event_detail['e_end_date'] ?>, 12:19 AM EST
                    </p><a href="#!">Add to Calendar</a>
                    <h6 class="mt-4">Location</h6>
                    <div class="mb-1"><?= $event_detail['e_address'] ?></div><a href="#view-map">View Map</a>
            ...
            <div class="card mb-3 mb-lg-0">
                ...
                <div class="card-footer bg-light p-0 border-top"><a class="btn btn-link d-block w-100"
                        href="event-list.html">All Events<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
            </div>
        </div>
    </div>
</div>
