...
<!-- Mirrored from wpkixx.com/html/pitnik/logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 03 Aug 2022 15:07:05 GMT -->
    ...
    <div class="theme-layout">
        ...
        <div class="responsive-header">
            <div class="mh-head first Sticky">
                ...
                <span class="mh-text">
                    <a href="" title=""><img src="<?= BASE_URL . PUBLIC_DIR ?>/assets/user/images/logos.png" alt=""></a>
                </span>
        ...
        <div class="topbar stick">
            <div class="logo">
                <a title="" href=""><img style="height: 70px;"
        ...
        <section>
            <div class="page-header">
                <div class="header-inner">
                    <h2>You have been logged out your account</h2>
                    <p>
                            ...
                            <div class="row border-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="already-log">
                                        <h4>Recent Login</h4>
                                        <p>Next Time you login click your picture. To remove an account from this page
                                            click cross.</p>
                                        <div class="log-user">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4">
                                                    <div class="user-log">
                                                        <i class="ti-close" title="Remove Account"></i>
                                                        <a href="#" title=""><img
                                                                src="<?= BASE_URL . PUBLIC_DIR ?>/assets/user/images/resources/author2.jpg"
                                                                alt="">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="logout-f">
                                        ...
                                        <div class="logout-form">
                                            <form method="post" action="<?= site_url('user-authentication') ?>"
                                                class="again-login">
                                                <input type="text" name="user_email" placeholder="Email Address">
                                                <input type="password" name="user_password" placeholder="Password">
                                                <button type="submit">Login</button>
                                            </form>
                                            <a href="<?= site_url('create-account') ?>" title="">Create New Signup</a>
                                            <p>By clicking Sign Up, you agree to our <a href="#" title="">Terms &
                                                    Policy</a>. You may receive SMS notifications from us and can opt
                                                out at any time.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="total">
                                            ...
                                            <em><?= $count_all_users['count_all_users'] ?></em>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="total">
                                    ...
                                    <div class="col-lg-4col-md-4 col-sm-4">
                                        <div class="total">
                                            ...
                                            <em><?= $count_all_offline_users['count_all_offline_users'] ?></em>
                                        </div>
                                    </div>
                                </div>
                            </div> -->
        ...
        <div class="bottombar">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <span class="copyright">© 2023 O R M E CO. All rights reserved.</span>
