...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 09:54:56 GMT -->
<!-- Added by HTTrack -->
        ...
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape"
                        src=".<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/icons/spot-illustrations/bg-shape.png"
