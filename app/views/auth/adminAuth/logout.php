...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/logout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 09:54:56 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <meta name="msapplication-TileImage"
        content="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/favicons/mstile-150x150.png" />
...
<body>
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        <div class="text-center"><img class="d-block mx-auto mb-4"
                                                src="<?= BASE_URL . PUBLIC_DIR ?>/assets/user/images/loader.png"
                                                alt="shield" width="100" />
                                            <h3>See you again!</h3>
                                            <p>Thanks for using Falcon. You are <br />now successfully signed out.</p><a
                                                class="btn btn-primary btn-sm mt-3" href="login.html"><span
    ...
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/echarts/echarts.min.js"></script>
