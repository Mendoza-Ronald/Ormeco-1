...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 09:54:56 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link href="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/overlayscrollbars/OverlayScrollbars.min.css"
        rel="stylesheet">
...
<body>
        ...
        <div class="container-fluid">
            <div class="row min-vh-100 flex-center g-0">
                <div class="col-lg-8 col-xxl-5 py-3 position-relative"><img class="bg-auth-circle-shape"
                        src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/icons/spot-illustrations/bg-shape.png" alt=""
                        width="250"><img class="bg-auth-circle-shape-2"
                        src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/icons/spot-illustrations/shape-1.png" alt=""
                        width="150">
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        <div class="bg-holder bg-auth-card-shape"
                                            style="background-image:url(<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/img/icons/spot-illustrations/half-circle.png);">
                                        </div>
                                        <!--/.bg-holder-->
                                        <div class="z-index-1 position-relative"><a
                                                class="link-light mb-4 font-sans-serif fs-4 d-inline-block fw-bolder"
                                                href="../../../index.html">ORMECO</a>
                                    ...
                                    <div class="mt-3 mb-4 mt-md-4 mb-md-5 light">
                                        <p class="pt-3 text-white">Have an account?<br><a
                                                ...
                                                href="<?= site_url('login-a-account') ?>">Log In</a></p>
                                    </div>
                                </div>
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form action="<?= site_url('create-a-account') ?>" method="POST"
                                            oninput='password_confirm.setCustomValidity(password_confirm.value != admin_password.value ? "Passwords do not match." : "")'>
                                            <div class="mb-3"><label class="form-label"
                                                    for="card-name">Name</label><input class="form-control"
                                                    name="username" type="text" autocomplete="on" id="card-name" />
                                            </div>
                                            <div class="mb-3"><label class="form-label" for="card-email">Email
                                                    address</label><input class="form-control" type="email"
                                                    name="admin_email" autocomplete="on" id="card-email" /></div>
                                            <div class="row gx-2">
                                                <div class="mb-3 col-sm-6"><label class="form-label"
                                                        for="card-password">Password</label><input class="form-control"
                                                        type="password" name="admin_password" autocomplete="on"
                                                        id="card-password" /></div>
                                                <div class="mb-3 col-sm-6"><label class="form-label"
                                                        for="card-confirm-password">Confirm Password</label><input
                                                        name="password_confirm" class="form-control" type="password"
                                                        autocomplete="on" id="card-confirm-password" /></div>
                                            </div>
                                            <div class="form-check"><input class="form-check-input" type="checkbox"
                                                    id="card-register-checkbox" /><label class="form-label"
                                                    for="card-register-checkbox">I accept the <a href="#!">terms </a>and
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/popper/popper.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/anchorjs/anchor.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/is/is.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/fontawesome/all.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/lodash/lodash.min.js"></script>
    <script src="../../../../../../polyfill.io/v3/polyfill.min58be.js?features=window.scroll"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/vendors/list.js/list.min.js"></script>
    <script src="<?= BASE_URL . PUBLIC_DIR ?>/assets/admin/js/theme.js"></script>
</body>
