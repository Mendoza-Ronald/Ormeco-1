...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 09:54:55 GMT -->
<!-- Added by HTTrack -->
                            ...
                            <div class="row g-0 h-100">
                                <div class="col-md-5 text-center bg-card-gradient">
                                    <div class="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div class="z-index-1 position-relative"><a
                                            ...
                                            <p class="opacity-75 text-white">With the power of ORMECO.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7 d-flex flex-center">
                                    <div class="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <?php flash_alert() ?>
                                        <form action="<?= site_url('account-a-verification') ?>" method="POST">

                                            <div class="mb-3">
                                                <div class="d-flex justify-content-between"><label class="form-label"
                                                        for="card-password">Verification Code</label></div>
                                                <input class="form-control" id="card-password" name="confirmation_code"
                                                    type="text" />
                                            </div>

                                            <div class="mb-3"><button class="btn btn-primary d-block w-100 mt-3"
                                                    type="submit" name="submit">Verify Account</button></div>
                                        </form>
...
<!-- Mirrored from prium.github.io/falcon/v3.4.0/pages/authentication/card/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 Jul 2022 09:54:56 GMT -->
